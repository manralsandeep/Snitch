...
import ContinueWithGoogle from '../components/ContinueWithGoggle';
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(err.response?.data?.message || err.message || "Registration failed");
        }
    }
                        ...
                        <form
                            ...
                            >
                                <div className="relative flex-shrink-0">
                                    ...
                                    {/* Custom checkbox */}
                                    <div
                                        className="w-4 h-4 border transition-all duration-200 flex items-center justify-center peer-checked:border-[#C9A96E] peer-checked:bg-[#C9A96E] border-[#d0c5b5]"
                                    >
                                        <svg className="w-2.5 h-2.5 hidden peer-checked:block" viewBox="0 0 12 12" fill="none">
                                            <path d="M2 6l3 3 5-5" stroke="#fbf9f6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <span
                                    className="text-[11px] uppercase tracking-[0.15em] transition-colors duration-200 text-[#7A6E63] group-hover:text-[#C9A96E]"
                                >
                                    Register as Seller
                                </span>
                            </label>
